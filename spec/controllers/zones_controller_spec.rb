...
RSpec.describe ZonesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new zone" do

        post :create, params: {zone: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(zone_url(Zone.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new zone" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the zone" do
        zone = Zone.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the zone" do
        zone = Zone.create! valid_attributes
